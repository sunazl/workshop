...
import static com.lt.workshop.manager.filter.FilterConstants.TOKEN_PREFIX;

import com.lt.workshop.manager.service.AuthenticationService;
...
class AuthenticationAwareFilter extends ZuulFilter {
  ...
  @Autowired
  public AuthenticationAwareFilter(
